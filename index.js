...
function fetchDeploymentResult() {
  ...
  const nomadEndpoint = "https://nomad.letapp.co";
  const nomadToken = "20cda6a9-c037-2dcd-995f-f36fea5d0ac9";
  const nomadJobName = "letapp-backend";
  const nomadNamespace = "oasis-prod";
